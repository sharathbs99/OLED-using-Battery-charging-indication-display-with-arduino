...
void setup()   {                
 ...
 // display.clearDisplay(); 
  ...
  delay(1000); 
/*display.drawRect(80, 4, 38, 10, WHITE);
  display.display();
delay(1000); 

  //display.drawRoundRect(80, 4, 40, 10, 10, WHITE);
  display.fillRect(81, 4, 8, 10, WHITE);
   display.display();

delay(1000);
     display.fillRect(90, 4, 8, 10, WHITE);
   display.display();

   delay(1000);
     display.fillRect(99, 4, 8, 10, WHITE);
   display.display();
      delay(1000);
     display.fillRect(108, 4, 8, 10, WHITE);
   display.display();*/
...
delay(1000);
  ...
  display.display();
//  display.drawPixel(81, 4, RED);
  //display.display();
delay(1000); 
//display.fillRect(81, 4, 5, 10, RED);
  // display.display();
  }
